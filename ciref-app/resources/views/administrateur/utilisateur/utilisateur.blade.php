            ...
            @csrf
                <div class="form">
                    ...
                    <div class="form-element">
                        ...
                        <input type="text" name="utilisateur_nom" placeholder="nom" required>
                    </div>
                    <div class="form-element">
                        <label for="cin">Mot de passe</label>
       ...
       <div class="mytable" style="width:50%, justify-content:center">
            <table id="example" class="table table-hover" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$val->utilisateur_nom}}</td>
                        <td>{{$val->utilisateur_password}}</td>
                        <td>
                            <a href="#" ><button type="button" id="show-popup1" class="btn btn-warning"><i class="fa fa-file-pen"></i></button></a>
                            <a href="#" onclick="confirmation(event)"><button type="button" class="btn btn-danger"><i class="fa fa-trash-can"></i></button>
                        </td>
                    @endforeach
                    </tr>
                </tbody>
