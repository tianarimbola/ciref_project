        ...
        <table id="example" class="table table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$val->surface}}</td>
                    <td>{{$val->commune}}</td>
                    <td>{{$val->quantite}} {{$val->unite}}s </td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td  class="flex-container">
                    <a href="{{route('autorisation_c.editPage',$vald->autorisation_c_id)}}"><button type="button" id="show-popup1" class="btn btn-warning"><i class="fa fa-file-pen"></i></button></a>
                    ...
                    <a href="{{route('autorisation_c.detail',$vald->autorisation_c_id)}}"><button type="button" class="btn btn-primary"><i class="fa-solid fa-truck"></i></button></a>
                </td>
            @endforeach
            </tr>
